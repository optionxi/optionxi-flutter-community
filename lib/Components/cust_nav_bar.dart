            ...
            child: Row(
              ...
              children: [
                _buildNavItem(0, Icons.home_outlined, Icons.home_rounded,
                    "Home", context),
                _buildNavItem(1, FontAwesomeIcons.magnifyingGlass,
                    FontAwesomeIcons.magnifyingGlass, "Search", context),
                _buildNavItem(2, FontAwesomeIcons.chartLine,
                    FontAwesomeIcons.chartLine, "Live", context),
                _buildNavItem(3, FontAwesomeIcons.chartPie,
                    FontAwesomeIcons.chartPie, "Movers", context),
