...
// ─────────────────────────────────────────────────────────────
class FragSearchMeili extends StatefulWidget {
  const FragSearchMeili({Key? key}) : super(key: key);

  @override
  State<FragSearchMeili> createState() => _FragSearchMeiliState();
}

class _FragSearchMeiliState extends State<FragSearchMeili>
                      ...
                      color: _isFav
                          ? const Color(0xFFFF6B35).withOpacity(
                              Theme.of(context).brightness == Brightness.dark
                                  ...
                                  : 0.10)
                          : Theme.of(context).brightness == Brightness.dark
                              ? const Color(0xFFFF6B35).withOpacity(0.07)
                              : const Color(0xFFFF6B35).withOpacity(0.04),
                      borderRadius: BorderRadius.circular(12),
                      border: Border.all(
                        color: const Color(0xFFFF6B35)
                            .withOpacity(_isFav ? 0.5 : 0.2),
                        width: 1.2,
                      ),
                    ),
                    child: Row(
                      ...
                      children: [
                        Icon(
                          ...
                          size: 16,
                          color: const Color(0xFFFF6B35)
                              .withOpacity(_isFav ? 1.0 : 0.6),
                        ),
                        const SizedBox(width: 7),
                        Text(
                          _isFav ? 'Watchlisted' : 'Watchlist',
                          style: TextStyle(
                            color: const Color(0xFFFF6B35)
                                .withOpacity(_isFav ? 1.0 : 0.6),
                            fontSize: 12.5,
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: Theme.of(context).brightness == Brightness.dark
                          ? const Color(0xFF4EA8DE).withOpacity(0.10)
                          : const Color(0xFF4EA8DE).withOpacity(0.07),
                      borderRadius: BorderRadius.circular(12),
                      border: Border.all(
                        color: const Color(0xFF4EA8DE).withOpacity(0.28),
                        width: 1.2,
                      ),
                    ),
                    child: Row(
                      ...
                      children: [
                        Icon(
                          ...
                          size: 16,
                          color: const Color(0xFF4EA8DE).withOpacity(0.85),
                        ),
                        const SizedBox(width: 7),
                        Text(
                          'Set Alert',
          ...
          AiAnalyseButton(
            onTap: () {
              Navigator.push(
                ...
                PageRouteBuilder(
                  pageBuilder: (_, a, __) =>
                      StockAiAnalysisPage(symbol: widget.displayName),
