...
import 'package:optionxi/Main_Pages/BrokersPage/Fyers/homepage_fyers.dart';
...
// ─────────────────────────────────────────────────────────────
class _FyersTheme {
  static const fyersBlue = Color(0xFF1B6FEB);
...
class _FyersConnectPageState extends State<FyersConnectPage>
  ...
  void _updateStateFromData(Map<String, dynamic> data,
    ...
    switch (newStatus) {
      ...
      case 'connection_failed':
        ...
        break;
      default:
        newMsg = 'Enter your App ID and Secret to get started';
    }
  ...
  Future<void> _saveCredentials() async {
    ...
    try {
      ...
      _showToast('Credentials saved — now authenticate with Fyers');
    } catch (e) {
  ...
  Future<void> _launchFyersAuthentication() async {
    if (_apiKeyController.text.trim().isEmpty) {
      _showToast('Please save a valid App ID first', isError: true);
      return;
    }
  ...
  Future<bool?> _showConfirmDialog() => showDialog<bool>(
        ...
        builder: (ctx) {
          ...
          return AlertDialog(
            backgroundColor: _FyersTheme.card(dark),
            shape:
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: _FyersTheme.errorRed.withOpacity(0.12),
                    borderRadius: BorderRadius.circular(10),
                  ),
                  child: const Icon(Icons.link_off_rounded,
                      color: _FyersTheme.errorRed, size: 20),
                ),
            ...
            content: Text(
              'This will delete your stored credentials and disconnect your Fyers account permanently.',
              style: TextStyle(color: _FyersTheme.textSecondary(dark)),
            ),
            actions: [
              TextButton(
              ...
              FilledButton(
                ...
                style: FilledButton.styleFrom(
                    backgroundColor: _FyersTheme.errorRed,
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                height: 4,
                decoration: BoxDecoration(
                  color: _FyersTheme.cardBorder(dark),
              ...
              Stack(
                ...
                children: [
                  Container(
                    ...
                    height: 80,
                    decoration: BoxDecoration(
                      color: _FyersTheme.successGreen.withOpacity(0.08),
                  ...
                  Container(
                    ...
                    height: 60,
                    decoration: BoxDecoration(
                      color: _FyersTheme.successGreen.withOpacity(0.15),
                      shape: BoxShape.circle,
                    ),
                  ),
                  const Icon(Icons.check_rounded,
                      color: _FyersTheme.successGreen, size: 32),
                ],
              ),
              ...
              Text(
                ...
                style: TextStyle(
                  ...
                  color: _FyersTheme.textPrimary(dark),
                ),
              ),
              const SizedBox(height: 8),
              Text(
                'Your Fyers account is linked and ready.\nStart trading now.',
                textAlign: TextAlign.center,
                style: TextStyle(
                  fontSize: 15,
                  color: _FyersTheme.textSecondary(dark),
                  height: 1.5,
                ),
              ),
              const SizedBox(height: 28),
                ...
                child: FilledButton.icon(
                  onPressed: () {
                    ...
                    Navigator.push(context,
                        MaterialPageRoute(builder: (_) => HomepageFyers()));
                  },
                  ...
                  style: FilledButton.styleFrom(
                    backgroundColor: _FyersTheme.successGreen,
  ...
  void _showToast(String message, {bool isError = false}) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
      ...
      backgroundColor: isError ? _FyersTheme.errorRed : const Color(0xFF1E293B),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: _FyersTheme.surface(dark),
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Start Trading CTA (if authenticated)
                  ...
                  // Step flow for non-authenticated
                  if (_status != 'authenticated') ...[
                    _buildStepFlow(dark),
                    const SizedBox(height: 24),
                  ],
          ...
          children: [
            ...
            Container(
              ...
              child: ClipRRect(
                borderRadius: BorderRadius.circular(8),
                child:
                    Image.asset('assets/brokers/fyers.png', fit: BoxFit.cover),
              ),
            ),
            const SizedBox(width: 10),
            Text(
        ...
        actions: [
          IconButton(
            icon: Icon(Icons.refresh_rounded,
                color: _FyersTheme.textSecondary(dark), size: 20),
  ...
  Widget _buildLiveDot(bool dark) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: isActive
            ? _FyersTheme.successGreen
            : isPending
                ? _FyersTheme.warningAmber
                : _FyersTheme.textSecondary(dark).withOpacity(0.4),
        shape: BoxShape.circle,
      ),
    );
  }
  ...
  Map<String, dynamic> _statusConfig(bool dark) {
    switch (_status) {
      case 'authenticated':
        return {
          'bg': _FyersTheme.successGreen.withOpacity(dark ? 0.1 : 0.06),
          'accent': _FyersTheme.successGreen,
          'icon': Icons.verified_rounded,
          'label': 'CONNECTED',
        };
      case 'credentials_saved':
        return {
          'bg': _FyersTheme.fyersBlue.withOpacity(dark ? 0.1 : 0.06),
          'accent': _FyersTheme.fyersBlue,
          'icon': Icons.task_alt_rounded,
          'label': 'CREDENTIALS SAVED',
        };
      case 'pending':
        return {
          'bg': _FyersTheme.warningAmber.withOpacity(dark ? 0.1 : 0.06),
          'accent': _FyersTheme.warningAmber,
      ...
      case 'error':
        return {
          'bg': _FyersTheme.errorRed.withOpacity(dark ? 0.1 : 0.06),
          'accent': _FyersTheme.errorRed,
          'icon': Icons.error_outline_rounded,
          'label': 'FAILED',
        };
      default:
        return {
          'bg': _FyersTheme.subtle(dark),
          'accent': _FyersTheme.textSecondary(dark),
  ...
  Widget _buildStepFlow(bool dark) {
    final steps = [
      _StepInfo(
        ...
        subtitle: 'Enter your App ID & Secret',
      ...
      _StepInfo(
        number: '2',
        title: 'Authenticate',
        subtitle: 'Login via Fyers OAuth',
          ...
          return Expanded(
            child: Container(
              ...
              color: leftStep.isDone
                  ? _FyersTheme.fyersBlue.withOpacity(0.5)
                  : _FyersTheme.cardBorder(dark),
            ),
          );
        }
  ...
  Widget _buildStepDot(_StepInfo step, bool dark) {
    ...
    if (step.isDone) {
      accentColor = _FyersTheme.fyersBlue;
      ...
      accentColor = _FyersTheme.cardBorder(dark);
      icon = Text(step.number,
          style: TextStyle(
              color: _FyersTheme.textSecondary(dark),
              fontSize: 12,
        ...
        Text(
          ...
          style: TextStyle(
            ...
            color: step.isActive || step.isDone
                ? _FyersTheme.textPrimary(dark)
                : _FyersTheme.textSecondary(dark),
          ),
        ),
      ],
    );
  ...
  Widget _buildStartTradingCard(bool dark) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: _FyersTheme.successGreen.withOpacity(0.3),
            blurRadius: 20,
        ...
        children: [
          ...
          FilledButton.icon(
            onPressed: () => Navigator.push(
                context, MaterialPageRoute(builder: (_) => HomepageFyers())),
            icon: const Icon(FontAwesomeIcons.chartLine, size: 14),
            label: const Text('Trade',
                style: TextStyle(fontWeight: FontWeight.w700, fontSize: 14)),
            style: FilledButton.styleFrom(
              backgroundColor: Colors.white,
              foregroundColor: _FyersTheme.successGreen,
  ...
  Widget _buildCredentialsCard(bool dark) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: _FyersTheme.card(dark),
        borderRadius: BorderRadius.circular(20),
        border: Border.all(color: _FyersTheme.cardBorder(dark)),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Row(
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: _FyersTheme.fyersBlue.withOpacity(0.1),
                  borderRadius: BorderRadius.circular(6),
                ),
                child: const Text('Fyers Developer',
                    style: TextStyle(
                        fontSize: 10,
                        color: _FyersTheme.fyersBlue,
                        fontWeight: FontWeight.w600)),
              ),
            ],
          ),
          const SizedBox(height: 4),
          Text(
            'Find these in your Fyers Developer dashboard',
            style:
                TextStyle(fontSize: 12, color: _FyersTheme.textSecondary(dark)),
          ),
          const SizedBox(height: 20),
          _buildInputField(
        ...
        AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: isFocused
                  ? _FyersTheme.fyersBlue
                  : _FyersTheme.inputBorder(dark),
              width: isFocused ? 1.5 : 1,
            ),
            color: _FyersTheme.inputFill(dark),
          ),
          child: TextFormField(
            ...
            decoration: InputDecoration(
              hintText: hint,
              hintStyle: TextStyle(
                  color: _FyersTheme.textSecondary(dark).withOpacity(0.5),
                  fontSize: 14),
              prefixIcon: Padding(
      ...
      return Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Text('Saving…',
                style: TextStyle(
                    color: _FyersTheme.textSecondary(dark), fontSize: 14)),
          ],
        ),
      );
    }
    ...
    switch (_status) {
      ...
      case 'connection_failed':
        return Column(
          children: [
            _primaryButton(
              label: 'Authenticate with Fyers',
              icon: Icons.open_in_browser_rounded,
              color: _FyersTheme.fyersBlue,
              onTap: _launchFyersAuthentication,
            ),
  ...
  Widget _ghostButton({
    ...
    final color =
        isDestructive ? _FyersTheme.errorRed : _FyersTheme.textSecondary(dark);
    return SizedBox(
      width: double.infinity,
  ...
  Widget _buildRedirectCard(bool dark) {
    const redirectUrl = 'https://fastapi.optionxi.com/broker/fyers';
    return Container(
      padding: const EdgeInsets.all(20),
      decoration: BoxDecoration(
        color: _FyersTheme.card(dark),
      ...
      child: Column(
        ...
        children: [
          Row(children: [
            Container(
              ...
              child: const Icon(Icons.link_rounded,
                  color: _FyersTheme.fyersBlue, size: 18),
            ),
            const SizedBox(width: 12),
            Text('Redirect URL',
                style: TextStyle(
          ...
          const SizedBox(height: 10),
          Text(
            'Add this URL as the redirect URI in your Fyers Developer app settings.',
            style: TextStyle(
                fontSize: 13,
                color: _FyersTheme.textSecondary(dark),
                height: 1.5),
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: _FyersTheme.subtle(dark),
                borderRadius: BorderRadius.circular(10),
                border: Border.all(
                  color: _FyersTheme.fyersBlue.withOpacity(0.2),
                ),
              ),
              child: Row(
                children: [
                  ...
                  Icon(Icons.copy_rounded,
                      size: 16, color: _FyersTheme.textSecondary(dark)),
                ],
              ),
            ),
          ),
          ...
          SizedBox(
            ...
            child: OutlinedButton.icon(
              ...
              label: const Text('Open Fyers Developer Portal',
                  style: TextStyle(fontSize: 13, fontWeight: FontWeight.w500)),
              style: OutlinedButton.styleFrom(
                foregroundColor: _FyersTheme.fyersBlue,
                side: BorderSide(color: _FyersTheme.fyersBlue.withOpacity(0.4)),
      ...
      child: Row(
        ...
        children: [
          Container(
            padding: const EdgeInsets.all(8),
            decoration: BoxDecoration(
              color: _FyersTheme.successGreen.withOpacity(0.1),
              borderRadius: BorderRadius.circular(10),
            ),
            child: const Icon(Icons.shield_rounded,
                color: _FyersTheme.successGreen, size: 18),
          ),
          const SizedBox(width: 12),
          Expanded(
            child: Column(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 4),
          Text(
            'Watch our step-by-step guide to connect Fyers',
            style:
                TextStyle(fontSize: 13, color: _FyersTheme.textSecondary(dark)),
          ),
          const SizedBox(height: 16),
          Row(
            children: [
              Expanded(
                child: FilledButton.icon(
                  onPressed: () async {
                    final url = Uri.parse(
                        'https://www.youtube.com/watch?v=-k-3eZQkxPU');
                    if (await canLaunchUrl(url)) {
                      await launchUrl(url,
                ...
                child: FilledButton.icon(
                  ...
                  label: const Text('Support',
                      style:
                          TextStyle(fontSize: 13, fontWeight: FontWeight.w600)),
                  style: FilledButton.styleFrom(
                    backgroundColor: _FyersTheme.fyersBlue,
                    foregroundColor: Colors.white,
                    padding: const EdgeInsets.symmetric(vertical: 12),
                    shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(10)),
  ...
  Widget _buildSectionDivider(String label, bool dark) {
    return Row(children: [
      Expanded(child: Divider(color: _FyersTheme.cardBorder(dark))),
      Padding(
            ...
            child: Column(
              ...
              children: [
                Container(
                  padding: const EdgeInsets.all(20),
                  decoration: BoxDecoration(
                    color: _FyersTheme.errorRed.withOpacity(0.1),
                    shape: BoxShape.circle,
                  ),
                  child: const Icon(Icons.account_circle_outlined,
                      color: _FyersTheme.errorRed, size: 48),
                ),
                const SizedBox(height: 24),
                ...
                const SizedBox(height: 8),
                Text(
                  'Please sign in to connect your Fyers account.',
                  textAlign: TextAlign.center,
                  style: TextStyle(
                      fontSize: 14,
                      color: _FyersTheme.textSecondary(dark),
